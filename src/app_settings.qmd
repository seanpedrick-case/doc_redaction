...
* **`VLM_DEFAULT_GREEDY`**
    * **Description:** Default greedy setting for VLM generation. `"False"` means use sampling (do_sample=True), `"True"` means use greedy decoding (do_sample=False). Used when model-specific defaults are not set.
    * **Default Value:** `"False"`
