...
The downside with this approach is that on pages with mixed text/images, the analysis will miss any text contained within the images. It is also not possible when you want to detect signatures or faces on your documents. To disable this feature, simply uncheck the 'Efficient OCR' checkbox and run your redaction task.
