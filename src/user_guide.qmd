...
Inside the same **'Redaction settings'** accordion, open the nested accordion **'Change default redaction settings'** (it may already be open). Under **'Change default text extraction OCR method'** you can choose how text is extracted:
...
Still under **'Change default redaction settings'**, the **'Change PII identification method'** section lets you choose how PII is detected:
