...
#### **Customising new redaction boxes**
...
When summarisation is enabled, a **Document summarisation** tab is shown in the app. It lets you generate LLM-based summaries from PDFs, or from OCR output CSVs (e.g. from a previous redaction run). Here is how you can summarise a document:
