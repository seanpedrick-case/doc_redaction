...
1.a **Upload PDF files**: In the summarisation tab, use "Upload one or multiple PDF files to summarise" to attach one or more PDF files.
1.b **Upload OCR output files**: In the summarisation tab, use "Upload one or multiple 'ocr_output.csv' files to summarise" to attach one or more `*_ocr_output.csv` files (produced by the redaction pipeline when you extract text from PDFs/images).
...
4. **Outputs**: When finished, you can download summary files and view the summary the appears below. You can copy this summary to the clipboard by clicking the button in the top right of the summary box.
