---
title: "Python package usage (doc_redaction)"
format:
  html:
    toc: true
    toc-depth: 3
...
Some workflows require **Tesseract** and **Poppler** on your system. You can either install them manually (see the [App installation guide](installation_guide.qmd)), or (recommended on Windows / no-admin setups) run:
