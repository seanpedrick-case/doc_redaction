...
After a document has been processed, you may need to redact specific terms, names, or phrases that the automatic PII (Personally Identifiable Information) detection might have missed. The **"Search text for new redaction"** tab gives you the power to find and redact any text within your document manually.
...
1.  Navigate to the **"Search text for new redaction"** tab.
