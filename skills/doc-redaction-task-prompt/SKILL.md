...
[`TASK_PROMPT_TEMPLATE.md`](TASK_PROMPT_TEMPLATE.md) is a **user-facing prompt** to start an agent on a full redact-and-review job. Quick checklist: [`PROMPT_TWEAKS.md`](PROMPT_TWEAKS.md). Anti-confusion rules live inside the template (§ **Agent anti-confusion rules**).
...
5. For **100+ pages**, read the **Long documents** appendix in the template (programmatic review, CLI/chunking, tiered Pass 1).
6. Send to the agent.
